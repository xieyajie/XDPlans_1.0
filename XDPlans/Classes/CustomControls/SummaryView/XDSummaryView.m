...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        _faceButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height / 2)];
        ...
        _faceTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, _faceButton.frame.origin.y + _faceButton.frame.size.height, self.frame.size.width, self.frame.size.height / 2)];
